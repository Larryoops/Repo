...
public class DataHandling {
	...
	/**
	 * magnitude of stride length
	 */
	private static double CurrentStride=(double) 0.0;
	...
	public static double[] getStepNumsAndTotalLength(List<double[] > accelerometer)
	{
		...
		//double threshold = averageLocalMeanAcceleration + 0.5;  test!! this is original
		double threshold = averageLocalMeanAcceleration +0.15;
